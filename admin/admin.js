...
const demoApplications = [
  { id:'demo-1', public_number:'RM-DEMO-001', status:'submitted', customer_name:'Анна Смирнова', company_name:'Бренд одежды', phone:'+7 999 000-00-00', email:'anna@example.com', receiving_city:'Москва', desired_ship_date:'2026-09-15', technology_code:'sublimation', quantity:500, submitted_at:'2026-08-28T09:30:00Z' },
  { id:'demo-2', public_number:'RM-DEMO-002', status:'in_review', customer_name:'Илья Волков', company_name:'Event Agency', phone:'+7 999 111-00-00', email:'ilya@example.com', receiving_city:'Санкт-Петербург', desired_ship_date:'2026-09-20', technology_code:'embroidery', quantity:200, submitted_at:'2026-08-28T08:10:00Z' },
];
...
function detailMarkup(application, files = [], events = []) {
